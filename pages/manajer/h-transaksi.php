...
$his_transaksi = 'active';
$tree_his = 'active';
$his_transaksi = $tree_his;
?>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>SIMON FP - History Transaksi</title>
    ...
    <?php include_once '../main-sidebar.php'; ?>
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Halaman<small>H-Transaksi</small></h1>
          <ol class="breadcrumb">
            ...
            <li class="active">H-Transaksi</li>
          </ol>
        </section>
        <!-- Main content -->
            ...
            <div class="col-md-12">
              <div class="box box-info">
                <div class="box-header">
                  <h3 class="box-title">List History Transaksi</h3>
                </div>
                <div class="box-body">
                  <table id="h-transaksi" class="table table-bordered table-hover">
                    <thead>
                      <tr>
                        <th>KODE BARANG</th>
                        <th>NAMA BARANG</th>
                    ...
                    <tbody>
                      <?php 
                        $oHT = new Transaksi();
                        $rowHT = $oHT->getHistoryTransaksi();
                        while ($hasil = $rowHT->fetch_assoc()) {
                      ?>
                      <tr>
